...
$$._JsSerializer = {"": "_Serializer;_nextFreeRefId,_visited",
  ...
  visitNativeJsSendPort$1: function(port) {
    return ["sendport", $globalState.currentManagerId, port._isolateId, port._receivePort.get$_liblib5$_id()];
  },
  visitIsolateSink$1: function(sink) {
...
$$.Stream = {"": "Object;",
  ...
  pipe$1: function(streamConsumer) {
    return streamConsumer.consume$1(this);
  },
...
$$._StreamImpl = {"": "Stream;_state@",
  ...
  _close$0: function() {
    ...
    if (!this.get$_mayFireState()) {
      this._addPendingEvent$1($.CONSTANT9);
      return;
    }
    if (this.get$_hasPendingEvent()) {
...
$$._StreamSubscriptionImpl = {"": "_StreamListener;_unsubscribeOnError,_onData,_onError,_onDone,_liblib6$_source,_state,_nextLink,_previousLink",
  ...
  _sendError$1: function(error) {
    ...
    if (this._unsubscribeOnError)
      this._liblib6$_source._cancel$1(this);
  },
  _sendDone$0: function() {
    this._onDone$0();
  },
...
$$._ForwardingStreamSubscription = {"": "_BaseStreamSubscription;_stream,_unsubscribeOnError,_subscription,_onData,_onError,_onDone",
  ...
  _ForwardingStreamSubscription$5: function(_stream, onData, onError, onDone, _unsubscribeOnError) {
    ...
    this._subscription = this._stream._liblib6$_source.listen$3$onDone$onError(t1, this.get$_handleDone(), t2);
  }
};
...
$$.ListQueue = {"": "Collection;_table,_liblib3$_head,_liblib3$_tail,_modificationCount",
  ...
  forEach$1: function(_, action) {
    ...
    for (i = this._liblib3$_head; i !== this._liblib3$_tail; i0 = (i + 1 & this._table.length - 1) >>> 0, i = i0) {
      t1 = this._table;
      if (i < 0 || i >= t1.length)
        throw $.ioore(i);
      action.call$1(t1[i]);
  ...
  get$length: function(_) {
    return $.$and$n($.$sub$n(this._liblib3$_tail, this._liblib3$_head), this._table.length - 1);
  },
  elementAt$1: function(_, index) {
    var t1, t2, t3;
    ...
    t1 = this._table;
    t2 = t1.length;
    t3 = (this._liblib3$_head + index & t2 - 1) >>> 0;
    if (t3 < 0 || t3 >= t2)
      throw $.ioore(t3);
    return t1[t3];
  },
  ...
  _filterWhere$2: function(test, removeMatching) {
    ...
    modificationCount = this._modificationCount;
    for (i = index; !$.$eq(i, this._liblib3$_tail);) {
      t1 = this._table;
      if (i !== (i | 0))
        throw $.iae(i);
      if (i < 0 || i >= t1.length)
  ...
  removeLast$0: function(_) {
    ...
    if (this._liblib3$_head === this._liblib3$_tail)
      throw $.$$throw($.StateError$("No elements"));
    this._modificationCount = this._modificationCount + 1;
    this._liblib3$_tail = $.$and$n($.$sub$n(this._liblib3$_tail, 1), this._table.length - 1);
    t1 = this._table;
  ...
  _add$1: function(element) {
    ...
    if (t2 < 0 || t2 >= t1.length)
      throw $.ioore(t2);
    t1[t2] = element;
    this._liblib3$_tail = $.$and$n(t2 + 1, this._table.length - 1);
    if (this._liblib3$_head === this._liblib3$_tail)
      this._grow$0();
    this._modificationCount = this._modificationCount + 1;
  },
  _remove$1: function(offset) {
    ...
    if (startDistance < (t4 - offset & mask) >>> 0) {
      ...
      this._liblib3$_tail = (t4 - 1 & mask) >>> 0;
  ...
  _remove$1$bailout: function(state0, offset, mask, startDistance, t1) {
    switch (state0) {
      case 0:
        ...
        startDistance = (offset - this._liblib3$_head & mask) >>> 0;
        t1 = this._liblib3$_tail;
      case 1:
        state0 = 0;
      case 2:
        ...
        if (state0 === 0 && startDistance < $.$and$n($.$sub$n(t1, offset), mask)) {
          for (t1 = this._table, t2 = t1.length, i = offset; t3 = this._liblib3$_head, i !== t3; i = prevOffset) {
            prevOffset = (i - 1 & mask) >>> 0;
            if (prevOffset < 0 || prevOffset >= t2)
              throw $.ioore(prevOffset);
            t3 = t1[prevOffset];
          ...
          switch (state0) {
            ...
            case 2:
              state0 = 0;
              this._liblib3$_tail = $.$and$n($.$sub$n(t1, 1), mask);
              for (t1 = this._table, t2 = t1.length, i = offset; t3 = this._liblib3$_tail, i !== t3; i = nextOffset) {
                nextOffset = (i + 1 & mask) >>> 0;
                if (nextOffset < 0 || nextOffset >= t2)
                  throw $.ioore(nextOffset);
  ...
  _grow$0: function() {
    ...
    $.JSArray_methods.setRange$4(newTable, split, this._liblib3$_head, this._table, 0);
    this._liblib3$_head = 0;
  ...
  _writeToList$1: function(target) {
    ...
    t1 = $.JSInt_methods.$le(this._liblib3$_head, this._liblib3$_tail);
    t2 = this._liblib3$_head;
    if (t1) {
      $length = $.$sub$n(this._liblib3$_tail, t2);
      $.JSArray_methods.setRange$4(target, 0, $length, this._table, this._liblib3$_head);
      return $length;
    } else {
      t1 = this._table;
      firstPartSize = t1.length - t2;
      $.JSArray_methods.setRange$4(target, 0, firstPartSize, t1, t2);
      $.JSArray_methods.setRange$4(target, firstPartSize, this._liblib3$_tail, this._table, 0);
...
$$._SplayTree = {"": "Object;",
  ...
  _remove$1: function(key) {
    ...
    t1 = $.get$left$x(this._liblib3$_root);
    t2 = this._liblib3$_root;
    if (t1 == null)
      this._liblib3$_root = $.get$right$x(t2);
    else {
      right = $.get$right$x(t2);
      this._liblib3$_root = $.get$left$x(this._liblib3$_root);
      this._splay$1(key);
      $.set$right$x(this._liblib3$_root, right);
    }
    this._modificationCount = this._modificationCount + 1;
    return result;
  },
  _addNewRoot$2: function(node, comp) {
    ...
    if (t1) {
      node.left = t2;
      node.right = $.get$right$x(this._liblib3$_root);
      $.set$right$x(this._liblib3$_root, null);
    } else {
      node.right = t2;
      node.left = $.get$left$x(this._liblib3$_root);
      $.set$left$x(this._liblib3$_root, null);
    }
    this._liblib3$_root = node;
  }
};
...
$$.SplayTreeMap = {"": "_SplayTree;_comparator,_liblib3$_root,_dummy,_count,_modificationCount,_splayCount",
  $index: function(_, key) {
    ...
    if (this._liblib3$_root != null)
      if (this._splay$1(key) === 0)
        return $.get$value$x(this._liblib3$_root);
    return;
  },
  remove$1: function(_, key) {
    var t1, root;
  ...
  $indexSet: function(_, key, value) {
    ...
    if (comp === 0) {
      $.set$value$x(this._liblib3$_root, value);
      return;
    }
...
$$._SplayTreeIterator = {"": "Object;",
  ...
  _rebuildWorkList$1: function(currentNode) {
    ...
    t1 = this._tree;
    if (currentNode == null)
      this._findLeftMostDescendent$1(t1._liblib3$_root);
    else {
      t1._splay$1($.get$key$x(currentNode));
      this._findLeftMostDescendent$1($.get$right$x(t1._liblib3$_root));
    }
  },
  moveNext$0: function() {
    var t1, t2;
  ...
  _SplayTreeIterator$1: function(tree) {
    this._findLeftMostDescendent$1(tree._liblib3$_root);
  }
};
...
$$._ChildrenElementList = {"": "Object;_liblib0$_element,_childElements",
  ...
  $indexSet: function(_, index, value) {
    $.$$dom_replaceChild$2$x(this._liblib0$_element, value, $.$index$asx(this._childElements, index));
  },
  add$1: function(_, value) {
    $.append$1$x(this._liblib0$_element, value);
    return value;
  },
  get$iterator: function(_) {
  ...
  addAll$1: function(_, iterable) {
    ...
    for (t1 = $.get$iterator$ax(iterable), t2 = this._liblib0$_element, t3 = $.getInterceptor$x(t2); t1.moveNext$0();)
  ...
  clear$0: function(_) {
    $.getInterceptor$x(this._liblib0$_element).textContent = "";
  },
  removeLast$0: function(_) {
    var result = this.get$last(this);
    if (result != null)
      $.$$dom_removeChild$1$x(this._liblib0$_element, result);
    return result;
  },
  get$last: function(_) {
...
$$._FrozenElementListIterator = {"": "Object;_list,_liblib0$_index,_current",
  moveNext$0: function() {
    var nextIndex, t1;
    nextIndex = $.$add$ns(this._liblib0$_index, 1);
    t1 = this._list;
...
$$._ElementAttributeMap = {"": "_AttributeMap;_liblib0$_element",
  $index: function(_, key) {
    return $.$$dom_getAttribute$1$x(this._liblib0$_element, key);
  },
  $indexSet: function(_, key, value) {
    $.$$dom_setAttribute$2$x(this._liblib0$_element, key, value);
  },
  remove$1: function(_, key) {
    var t1, t2, value;
    t1 = this._liblib0$_element;
...
$$.ChatBoxComponent = {"": "WebComponent;_root,__e7,__e8,__t,messages<,completer<,_element,_shadowRoots",
  created_autogenerated$0: function() {
    this._root = this.createShadowRoot$0(this);
    this.__t = $.Template$(this._root);
    $.add$1$ax($.get$nodes$x(this._root), $.clone$1$x($.get$ChatBoxComponent___shadowTemplate(), true));
    this.__e7 = $.query$1$x(this._root, "#__e-7");
    var t1 = this.__t;
    t1.loop$3(t1, this.__e7, new $.ChatBoxComponent_created_autogenerated_anon(this), new $.ChatBoxComponent_created_autogenerated_anon0());
    this.__e8 = $.query$1$x(this._root, "#__e-8");
    this.__t.conditional$3(this.__e8, new $.ChatBoxComponent_created_autogenerated_anon1(this), new $.ChatBoxComponent_created_autogenerated_anon2());
    this.__t.create$0();
  },
  ...
  consume$1: function(stream) {
    var t1, t2;
    t1 = this.get$_onMessage();
    t2 = this.get$_liblib7$_onError();
    stream.listen$4$onDone$onError$unsubscribeOnError(t1, this.get$_liblib7$_onDone(), t2, true);
    return this.completer.future;
  },
  _onMessage$1: function(message) {
    this.messages.push(message);
    $.dispatch();
    $.Primitives_printString($.S(message.get$timestamp()) + " -  " + message.get$from() + ": " + $.S($.get$message$x(message)));
  },
  get$_onMessage: function() {
    return new $.BoundClosure$1(this, "_onMessage$1");
  },
  _liblib7$_onError$1: function(error) {
    $.Primitives_printString("Error: " + $.S(error));
  },
  get$_liblib7$_onError: function() {
    return new $.BoundClosure$1(this, "_liblib7$_onError$1");
  },
  _liblib7$_onDone$0: function() {
    var t1 = this.completer;
    t1.complete$1(t1, this.messages);
    $.dispatch();
  },
  get$_liblib7$_onDone: function() {
    return new $.BoundClosure$0(this, "_liblib7$_onDone$0");
  },
  reset$0: function(_) {
    this.messages = $.List_List($);
    this.completer = $._CompleterImpl$();
  }
};

$$.ChatBoxComponent_created_autogenerated_anon = {"": "Closure;this_0",
  call$0: function() {
...
$$.ChatBoxComponent_created_autogenerated_anon0 = {"": "Closure;",
  call$2: function(message, __t) {
    var __e6, t1, __e1, __binding0, __e3, __binding2, __e5, __binding4;
    __e6 = $.clone$1$x($.get$ChatBoxComponent___html1(), true);
    t1 = $.getInterceptor$x(__e6);
    __e1 = t1.query$1(__e6, "#__e-1");
    __binding0 = __t.contentBind$2(new $.ChatBoxComponent_created_autogenerated__anon(message), false);
    $.add$1$ax($.get$nodes$x(__e1), __binding0);
    __e3 = t1.query$1(__e6, "#__e-3");
    __binding2 = __t.contentBind$2(new $.ChatBoxComponent_created_autogenerated__anon0(message), false);
    $.add$1$ax($.get$nodes$x(__e3), __binding2);
    __e5 = t1.query$1(__e6, "#__e-5");
    __binding4 = __t.contentBind$2(new $.ChatBoxComponent_created_autogenerated__anon1(message), false);
...
$$.ChatBoxComponent_created_autogenerated__anon = {"": "Closure;message_1",
  call$0: function() {
    return this.message_1.get$timestamp();
  },
  $isFunction: true
};

$$.ChatBoxComponent_created_autogenerated__anon0 = {"": "Closure;message_2",
  call$0: function() {
    return this.message_2.get$from();
  },
  $isFunction: true
};

$$.ChatBoxComponent_created_autogenerated__anon1 = {"": "Closure;message_3",
  call$0: function() {
    return $.get$message$x(this.message_3);
  },
  $isFunction: true
};

$$.ChatBoxComponent_created_autogenerated_anon1 = {"": "Closure;this_4",
  call$0: function() {
    return this.this_4.get$completer().get$isCompleted();
  },
  $isFunction: true
};

$$.ChatBoxComponent_created_autogenerated_anon2 = {"": "Closure;",
  call$1: function(__t) {
    $.addAll$1$ax(__t, [document.createTextNode("\n          "), $.clone$1$x($.get$ChatBoxComponent___html2(), true), document.createTextNode("\n        ")]);
  },
  $isFunction: true
};
...
$$.main_anon = {"": "Closure;",
  call$1: function(_) {
    var stream, chatbox;
    $.getInterceptor$x($.callTypeCast($.query$1$x(document, "#start"), "$isButtonElement")).disabled = true;
    stream = $.getChatStream();
    chatbox = $.get$xtag$x($.query$1$x(document, "#chatbox"));
    $.reset$0$x(chatbox);
    stream.pipe$1(chatbox).then$1(new $.main__anon());
  },
  $isFunction: true
};
...
$$.main__anon = {"": "Closure;",
  call$1: function(_) {
    $.getInterceptor$x($.callTypeCast($.query$1$x(document, "#start"), "$isButtonElement")).disabled = false;
  },
  $isFunction: true
};

$$.getChatStream_anon = {"": "Closure;messages_0,controller_1",
  call$1: function(timer) {
    ...
    if (t2 > 0) {
      message = $.JSArray_methods.removeAt$1(t1, 0);
      message.set$timestamp($.DateTime$_now());
      t3.add$1(t3, message);
    } else {
      t3.close$0(t3);
      timer.cancel$0();
...
$$.ChatMessage = {"": "Object;from<,message>,timestamp@"};
  ...
  moveNext$0: function() {
    ...
    do {
      ...
      if (t1 < t3) {
        ...
        if (t1 < 0 || t1 >= t3)
          throw $.ioore(t1);
        t4 = $.$eq(t2[t1].get$_liblib1$_list(), this._liblib1$_list) !== true;
        t1 = t4;
      } else
        t1 = false;
    } while (t1);
...
$$.Template = {"": "TemplateItem;node<,children>,nodes>",
  ...
  loop$3: function($receiver, template, exp, iterSetup) {
    return this.loop$4$isTemplateElement($receiver, template, exp, iterSetup, true);
  },
...
$$._Watcher = {"": "Object;debugName,_getter,_liblib8$_callback,_lastValue",
  ...
  compareAndNotify$0: function() {
    ...
    if (this._compare$1(currentValue) === true) {
      ...
      this._liblib8$_callback$1($.ChangeNotification$(oldValue, currentValue, null));
      return true;
    }
    return false;
  },
...
$._ListQueueIterator$ = function(queue) {
  return new $._ListQueueIterator(queue, queue._liblib3$_tail, queue._modificationCount, queue._liblib3$_head, null);
};
...
$._ElementFactoryProvider_createElement_html = function(html) {
  ...
  if (match != null) {
    ...
    if ($.Device_isIE() === true && $.CONSTANT3.containsKey$1(tag))
      return $._ElementFactoryProvider__createTableForIE(html, tag);
    parentTag = $.CONSTANT4.$index($.CONSTANT4, tag);
    if (parentTag == null)
      parentTag = "div";
  } else {
    parentTag = "div";
...
$.ChatBoxComponent$forElement = function(e) {
  var t1 = new $.ChatBoxComponent(null, null, null, null, $.List_List($), $.Completer_Completer(), e, null);
  t1.WebComponent$forElement$1(e);
  return t1;
};

$.main = function() {
  $.get$onClick$x($.query$1$x(document, "#start")).listen$1(new $.main_anon());
};

$.getChatStream = function() {
  var t1, t2, t3, controller;
  t1 = $.ChatMessage$("Tom", "My dog has no nose");
  t2 = $.ChatMessage$("Sally", "Really, how does he smell?");
  t3 = $.ChatMessage$("Tom", "Terrible!");
  controller = $.StreamController$(null, null);
  $.Timer_Timer$periodic($.Duration$(0, 0, 0, 0, 0, 1), new $.getChatStream_anon([t1, t2, t3], controller));
  return controller.stream;
};

$.ChatMessage$ = function(from, message) {
  return new $.ChatMessage(from, message, null);
};
...
$.init_autogenerated = function() {
  ...
  t1.query$1(_root, "#start");
  __t.component$1($.ChatBoxComponent$forElement($.query$1$x(t1.query$1(_root, "#sample_container_id"), "#chatbox")));
  __t.create$0();
  __t.insert$0(__t);
};
...
$.CONSTANT3 = new $.ConstantMap(9, {caption: null, col: null, colgroup: null, tbody: null, td: null, tfoot: null, th: null, thead: null, tr: null}, $.CONSTANT11);
$.CONSTANT = new $.NullThrownError();
$.CONSTANT5 = new $.EventStreamProvider("click");
...
$.CONSTANT4 = new $.ConstantMap(12, {body: "html", head: "html", caption: "table", td: "tr", th: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, $.CONSTANT12);
$.JSNull_methods = $.JSNull.prototype;
$.JSString_methods = $.JSString.prototype;
$.JSNumber_methods = $.JSNumber.prototype;
$.CONSTANT8 = new $.CloseToken();
$.JSInt_methods = $.JSInt.prototype;
$.CONSTANT9 = new $._DelayedDone();
...
Isolate.$lazy($, "__html1", "ChatBoxComponent___html1", "get$ChatBoxComponent___html1", function() {
  return $.Element_Element$html("<div>\n            <span class=\"timestamp\" id=\"__e-1\"></span>\n            <span class=\"from\" id=\"__e-3\"></span>\n            <span class=\"message\" id=\"__e-5\"></span>\n          </div>");
});
Isolate.$lazy($, "__html2", "ChatBoxComponent___html2", "get$ChatBoxComponent___html2", function() {
  return $.Element_Element$html("<div>No more messages</div>");
});
Isolate.$lazy($, "__shadowTemplate", "ChatBoxComponent___shadowTemplate", "get$ChatBoxComponent___shadowTemplate", function() {
...
$.$defineNativeClass("Element", {"": "xtag%,$$dom_children:children=,id=,innerHtml:innerHTML},tagName=",
...
$.$defineNativeClass("Node", {"": "nextNode:nextSibling=,parent:parentElement=,parentNode=,text:textContent}",
...
//@ sourceMappingURL=streams_client.html_bootstrap.dart.js.map
